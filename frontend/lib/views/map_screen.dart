                ...
                Positioned(
                  ...
                  child: Wrap(
                    ...
                    children: [
                      ...
                      ElevatedButton.icon(
                        onPressed: _createLocation == null
                            ? null
                            : _createLocationalChatroom,
                      ...
                      if (_createLocation != null)
                        Chip(
                          ...
                          label: Text(
                            '${_createLocation!.latitude.toStringAsFixed(4)}, '
                            '${_createLocation!.longitude.toStringAsFixed(4)}',
                          ),
                        ),
                    ],
                  ),
